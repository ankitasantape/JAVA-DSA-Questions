...
public class WaysToMakeCoinChange {
	...
	public static int countWaysToMakeChangeRec(int denominations[], int value){
           
          return countWays( denominations, 0, value );  
	}
	
	private static int countWays(int []deno, int index, int value) {
		if(value > 0 && index == deno.length) {
			return 0;
		}
		if(value == 0) {
			return 1;
		...
		return countWays(deno, index + 1, value) + countWays(deno, index, value - deno[index]);
	...
	public static void main(String[] args) {
	       ...
	       System.out.println( countWaysToMakeChangeRec( a, v ));
	       System.out.println( countWaysToMakeChangeM( a, v ));
