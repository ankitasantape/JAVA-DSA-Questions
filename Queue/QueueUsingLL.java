...
'x' is the range for every query and data represents the integer pushed into the queue. 
...
public class QueueUsingLL {
	...
	private Node front;
	private Node rear;
	// Agar queue ki length nikalni hai to har bar hume LL ko traverse krna padega but hume aisa nahi krna to  
	// hum size variable ki help le skte hai jb bhi enqueue krna hai size++ krenge aur dequeue krna hai to size-- krenge usse hume actual size return kr skte hai
	private int size;
	
	
	public QueueUsingLL() {
		
		front = null; // front ki value nhi bhi set krte to bhi iski value = null hi rhti becoz ye non-primitive hai aur non-primitive ki default value null hoti ha
		rear = null;
		size = 0;
